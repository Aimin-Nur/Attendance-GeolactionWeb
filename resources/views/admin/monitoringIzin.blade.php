...
<div class="page-wrapper">
  ...
  @foreach ($dataKaryawan as $karyawan )
  <div class="modal modal-blur fade" id="modal-danger{{$karyawan->id}}" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-sm modal-dialog-centered" role="document">
      <div class="modal-content">
        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
        <div class="modal-status bg-warning"></div>
        <form action="/perizinanKaryawan/{{$karyawan->id}}" method="POST" enctype="multipart/form-data">
          @csrf
        ...
        <div class="modal-footer">
          <div class="w-100">
            <div class="row">
              ...
              <div class="col"><button type="submit" href="#" class="btn btn-warning w-100" data-bs-dismiss="modal">
                  Ya, Saya Yakin
                </button></div>
            </div>
          </div>
