          ...
          <div class="navbar">
            <div class="container-xl">
              <ul class="navbar-nav">
                ...
                <li class="nav-item {{ request()->is('dataKaryawan') ? 'active' : '' }}">
                ...
                <li class="nav-item {{ request()->is('monitoring/absen')  ??  request()->is('monitoring/absen') ? 'active' : '' }}">
                  <a class="nav-link" href="/monitoring/absen" >
                    <span class="nav-link-icon d-md-none d-lg-inline-block"><!-- Download SVG icon from http://tabler-icons.io/i/checkbox -->
                ...
                <li class="nav-item {{ request()->is('monitoring/perizinan')  ??  request()->is('monitoring/perizinan') ? 'active' : '' }}">
                  <a class="nav-link" href="/monitoring/perizinan" >
                    <span class="nav-link-icon d-md-none d-lg-inline-block"><!-- Download SVG icon from http://tabler-icons.io/i/checkbox -->
                ...
                <li class="nav-item {{ request()->is('portal/laporan')  ??  request()->is('monitoring/pelaporan') ? 'active' : '' }}">
                  <a class="nav-link" href="/portal/laporan" >
                    <span class="nav-link-icon d-md-none d-lg-inline-block"><!-- Download SVG icon from http://tabler-icons.io/i/checkbox -->
